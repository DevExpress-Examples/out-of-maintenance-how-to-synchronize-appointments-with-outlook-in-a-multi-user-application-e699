...
Namespace MultiUserOutlookSync
	...
	Partial Public Class DataSet1
		...
		Partial Public Class ScheduleDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddScheduleRow(ByVal UserID As Integer, ByVal StartTime As System.DateTime, ByVal EndTime As System.DateTime, ByVal Subject As String, ByVal Label As Integer, ByVal Description As String, ByVal OutlookEntryID As String) As ScheduleRow
			...
			Protected Overrides Sub OnRowChanged(ByVal e As Global.System.Data.DataRowChangeEventArgs)
				MyBase.OnRowChanged(e)
				If (Me.ScheduleRowChangedEvent IsNot Nothing) Then
			...
			Protected Overrides Sub OnRowChanging(ByVal e As Global.System.Data.DataRowChangeEventArgs)
				MyBase.OnRowChanging(e)
				If (Me.ScheduleRowChangingEvent IsNot Nothing) Then
			...
			Protected Overrides Sub OnRowDeleted(ByVal e As Global.System.Data.DataRowChangeEventArgs)
				MyBase.OnRowDeleted(e)
				If (Me.ScheduleRowDeletedEvent IsNot Nothing) Then
			...
			Protected Overrides Sub OnRowDeleting(ByVal e As Global.System.Data.DataRowChangeEventArgs)
				MyBase.OnRowDeleting(e)
				If (Me.ScheduleRowDeletingEvent IsNot Nothing) Then
		...
		Partial Public Class ScheduleRow
			...
			Public Property ID() As Integer
				Get
					Return (CInt(Fix(Me(Me.tableSchedule.IDColumn))))
				End Get
				Set(ByVal value As Integer)
			...
			Public Property UserID() As Integer
				Get
					Try
						Return (CInt(Fix(Me(Me.tableSchedule.UserIDColumn))))
					Catch e As Global.System.InvalidCastException
			...
			Public Property Label() As Integer
				Get
					Try
						Return (CInt(Fix(Me(Me.tableSchedule.LabelColumn))))
					Catch e As Global.System.InvalidCastException
...
Namespace MultiUserOutlookSync.DataSet1TableAdapters
	...
	Partial Public Class UsersTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT        Users.*" & Constants.vbCrLf & "FROM            Users"
	...
	Partial Friend Class ScheduleTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0) = New Global.System.Data.OleDb.OleDbCommand()
			Me._commandCollection(0).Connection = Me.Connection
			Me._commandCollection(0).CommandText = "SELECT     Schedule.*" & Constants.vbCrLf & "FROM         Schedule"
			Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
			Me._commandCollection(1) = New Global.System.Data.OleDb.OleDbCommand()
			Me._commandCollection(1).Connection = Me.Connection
			Me._commandCollection(1).CommandText = "SELECT     Schedule.*" & Constants.vbCrLf & "FROM         Schedule" & Constants.vbCrLf & "WHERE UserID = :UserID"
		...
		Public Overridable Function FillBy(ByVal dataTable As DataSet1.ScheduleDataTable, ByVal UserID As Integer) As Integer
			...
			Me.Adapter.SelectCommand.Parameters(0).Value = (CInt(Fix(UserID)))
			If (Me.ClearBeforeFill = True) Then
				dataTable.Clear()
			End If
			Dim returnValue As Integer = Me.Adapter.Fill(dataTable)
		...
		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Delete, True)> _
		Public Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_UserID As Global.System.Nullable(Of Integer), ByVal Original_StartTime As Global.System.Nullable(Of Global.System.DateTime), ByVal Original_EndTime As Global.System.Nullable(Of Global.System.DateTime), ByVal Original_Subject As String, ByVal Original_Label As Global.System.Nullable(Of Integer), ByVal Original_Description As String, ByVal Original_OutlookEntryID As String) As Integer
			Me.Adapter.DeleteCommand.Parameters(0).Value = (CInt(Fix(Original_ID)))
		...
		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, True)> _
		Public Overridable Function Insert(ByVal UserID As Global.System.Nullable(Of Integer), ByVal StartTime As Global.System.Nullable(Of Global.System.DateTime), ByVal EndTime As Global.System.Nullable(Of Global.System.DateTime), ByVal Subject As String, ByVal Label As Global.System.Nullable(Of Integer), ByVal Description As String, ByVal OutlookEntryID As String) As Integer
		...
		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, True)> _
		Public Overridable Function Update(ByVal UserID As Global.System.Nullable(Of Integer), ByVal StartTime As Global.System.Nullable(Of Global.System.DateTime), ByVal EndTime As Global.System.Nullable(Of Global.System.DateTime), ByVal Subject As String, ByVal Label As Global.System.Nullable(Of Integer), ByVal Description As String, ByVal OutlookEntryID As String, ByVal Original_ID As Integer, ByVal Original_UserID As Global.System.Nullable(Of Integer), ByVal Original_StartTime As Global.System.Nullable(Of Global.System.DateTime), ByVal Original_EndTime As Global.System.Nullable(Of Global.System.DateTime), ByVal Original_Subject As String, ByVal Original_Label As Global.System.Nullable(Of Integer), ByVal Original_Description As String, ByVal Original_OutlookEntryID As String) As Integer
			If (UserID.HasValue = True) Then
			...
			End If
			Me.Adapter.UpdateCommand.Parameters(7).Value = (CInt(Fix(Original_ID)))
			If (Original_UserID.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(8).Value = (CObj(0))
				Me.Adapter.UpdateCommand.Parameters(9).Value = (CInt(Fix(Original_UserID.Value)))
			Else
				Me.Adapter.UpdateCommand.Parameters(8).Value = (CObj(1))
				Me.Adapter.UpdateCommand.Parameters(9).Value = Global.System.DBNull.Value
			End If
			...
			If (Original_Label.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(17).Value = (CInt(Fix(Original_Label.Value)))
			Else
